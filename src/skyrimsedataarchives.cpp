...
SkyrimSEDataArchives::SkyrimSEDataArchives(const QDir& myGamesDir) : GamebryoDataArchives(myGamesDir)
{}
...
QStringList SkyrimSEDataArchives::archives(const MOBase::IProfile* profile) const
{
  ...
  QString iniFile = profile->localSettingsEnabled()
    ? QDir(profile->absolutePath()).absoluteFilePath("Skyrim.ini") : m_LocalGameDir.absoluteFilePath("Skyrim.ini");
